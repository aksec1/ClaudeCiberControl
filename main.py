...
def parse_args():
    ...
    parser.add_argument("target", nargs="?", help="IP, dominio o URL objetivo")
    parser.add_argument("-p", "--profile", default="default",
        choices=["fast", "default", "full", "vuln", "stealth", "udp", "comprehensive"],
        help="Perfil de escaneo nmap (default: default)")
    parser.add_argument("--no-web", action="store_true", help="Omitir escaneo web")
    parser.add_argument("--no-report", action="store_true", help="No generar reportes")
    parser.add_argument("--report-only-json", action="store_true", help="Solo reporte JSON")
    parser.add_argument("-o", "--output", default="output/reports", help="Directorio de salida")
    ...
    parser.add_argument("--demo", action="store_true", help="Demo con scanme.nmap.org")
...
def run_scan(target: str, profile: str, verbose: bool, no_web: bool):
...
def print_summary(result):
    ...
    print()
    colors = {"CRITICAL": "\033[91m", "HIGH": "\033[93m", "MEDIUM": "\033[94m", "LOW": "\033[92m", "INFO": "\033[96m"}
...
def main():
    ...
    if not args.target:
        print("\033[91m[ERROR] Debe especificar un objetivo.\033[0m")
        print("Ejemplo: python3 main.py 192.168.1.1")
        print("Uso: ./run.sh --demo")
        sys.exit(1)
    ...
    try:
        ...
        print("\n\033[93m[!] Escaneo interrumpido\033[0m")
        sys.exit(0)
    ...
    print(f"\n\033[92m[+] Escaneo completado\033[0m\n")
